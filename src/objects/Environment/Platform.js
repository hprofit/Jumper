...
export function loadCakePlatformImages(game) { loadPlatformImages(game, 'cake'); }

export function loadGrassPlatformImages(game) { loadPlatformImages(game, 'grass'); }

export function loadSandPlatformImages(game) { loadPlatformImages(game, 'sand'); }

export function loadSnowPlatformImages(game) { loadPlatformImages(game, 'snow'); }

export function loadStonePlatformImages(game) { loadPlatformImages(game, 'stone'); }

export function loadWoodPlatformImages(game) { loadPlatformImages(game, 'wood'); }
